...
import modeling_finetune_image
import cv2
...
#     model,
#     dummy_input,
#     "./onnx_export/beit3_retrival_coco_img.onnx",
#     dynamic_axes={
#         'input': {0: 'batch_size'},  # The '0' indicates the dimension you want to be dynamic
#         'output': {0: 'batch_size'}
#     }
...
#                     output_names=["img_feature"],	# 输出名
#                     dynamic_axes={"input_img":{0:"batch_size"},		# 批处理变量
#                                  "img_feature":{0:"batch_size"}})

torch.onnx.export(model,
                    dummy_input,
                    "./onnx_export/beit3_retrival_coco_img_constant.onnx",
                    opset_version=13,
                    export_params=True,
                    verbose=False,
                    do_constant_folding=True,	# 是否执行常量折叠优化
