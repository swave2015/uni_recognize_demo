...
onnx_path = '/data/xcao/code/uni_recognize_demo/algorithms/onnx_export/blip2_itm_constant.onnx'
ort_session = ort.InferenceSession(onnx_path)

inputs = {
    'input_img': img,
    'token_input_ids': text_token.input_ids,
    'token_attention_mask': text_token.attention_mask
