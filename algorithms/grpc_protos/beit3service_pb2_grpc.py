...
class ClientServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.ReceiveInferResult = channel.unary_unary(
                '/beit3service.ClientService/ReceiveInferResult',
                request_serializer=beit3service__pb2.CallBackResult.SerializeToString,
                response_deserializer=beit3service__pb2.ClientResponse.FromString,
                )
...
def add_ClientServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ReceiveInferResult': grpc.unary_unary_rpc_method_handler(
                    servicer.ReceiveInferResult,
                    request_deserializer=beit3service__pb2.CallBackResult.FromString,
                    response_serializer=beit3service__pb2.ClientResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'beit3service.ClientService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class ClientService(object):
    ...
    @staticmethod
    def ReceiveInferResult(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/beit3service.ClientService/ReceiveInferResult',
            beit3service__pb2.CallBackResult.SerializeToString,
            beit3service__pb2.ClientResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
